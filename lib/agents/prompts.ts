...
export function buildTutorUserPrompt(args: TutorPromptArgs): string {
  ...
  return [
    ...
    `- For the same concept, always keep Definition and Explanation consistent. If book content exists, use it exactly without any change. If generating, do not rephrase or vary wording across responses. The Example and Formula may vary only if needed for clarity.`,
